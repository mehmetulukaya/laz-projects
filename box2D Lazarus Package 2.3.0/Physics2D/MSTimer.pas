...
var
   ...
   function MU_AllocateHWnd(AMethod: TWndMethod): HWND;
     var
       TempClass: TWndClass;
  ...
  procedure MU_DeallocateHWnd(Wnd: HWND);
  var
    Instance: Pointer;
  begin
...
begin
   inherited Create;
   FWindowHandle := MU_AllocateHWnd(WndProc);
   Trigger;
end;
...
begin
   ...
   MU_DeallocateHWnd(FWindowHandle);
   inherited Destroy;
end;
