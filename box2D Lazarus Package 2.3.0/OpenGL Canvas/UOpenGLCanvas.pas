...
begin
            ...
            case TransformType of
               ttScale:
                  begin
                     ...
                     glScalef(var1, var2, 1.0);
                     tx := tx * var1;
                     ty := ty * var2;
                  end;
               // ttTranslate: glTranslate(var1, var2, 0.0);
               ttTranslate: glTranslatef(var1, var2, 0.0);
   ...
   begin
      glLoadIdentity;
      glTranslatef(FTranslateX, FTranslateY, 0.0);
      glScalef(FScaleX, FScaleY, 1.0);
