...
type
 ...
 platform_specific = object
   ...
   procedure caption_ (capt : char_ptr );
 ...
 platform_support = object
  ...
  // (depending on implementation)
   procedure message_(msg : char_ptr );
...
begin
 ...
 if m_specific.m_initialized then
  m_specific.caption_(char_ptr(@m_caption[1 ] ) );

end;

{ isdigit }
function isdigit(c : char8 ) : boolean;
begin
 case c of
  '0'..'9' :
   result:=true;
