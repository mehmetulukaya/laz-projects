...
{ GLOBAL PROCEDURES }
 ...
 procedure sprintf  (dst : char_ptr; src : char_ptr; val : double );
...
{ MAKESTR }
function MakeStr(ch : char8; sz : byte ) : shortstring;
begin
 result[0 ]:=char8(sz );
...
const
 low : array[0..$f ] of char8 = '0123456789abcdef';
 hex : array[0..$f ] of char8 = '0123456789ABCDEF';
