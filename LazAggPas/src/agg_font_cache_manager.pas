...
type
 ...
 font_cache = object
   ...
   m_font_signature : char_ptr;

   constructor Construct(font_signature : char_ptr );
   destructor  Destruct;

   function  font_is(font_signature : char_ptr ) : boolean;
 ...
 font_cache_pool = object
   ...
   procedure font_(font_signature : char_ptr; reset_cache : boolean = false );
   ...
   function  find_font(font_signature : char_ptr ) : int;
...
begin
 ...
 m_font_signature:=char_ptr(m_allocator.allocate(StrLen(font_signature ) + 1 ) );
