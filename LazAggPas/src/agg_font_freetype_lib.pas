...
type
 FT_Encoding = array[0..3 ] of char8;
...
{ GLOBAL PROCEDURES }
 function  FT_CURVE_TAG  (flag : char8 ) : char8;
 ...
 function  FT_Attach_File(face : FT_Face_ptr; filepathname : char_ptr ) : FT_Error; cdecl; external ft_lib name 'FT_Attach_File';
