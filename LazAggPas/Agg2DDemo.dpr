...
{ m_graphics.font(char_ptr(FONT_TIMES ) ,14.0 ,false ,false );
 ...
 m_graphics.noLine;
 m_graphics.text(100 ,20 ,char_ptr(char_ptr('Regular Raster Text -- Fast, but can''t be rotated' ) ) );{}
...
// Outlined Text
 ...
 m_graphics.text(100.5 ,50.5 ,char_ptr(char_ptr('Outlined Text' ) ) );
...
// Text Alignment
 ...
 m_graphics.text(250.0 ,150.0 ,char_ptr(char_ptr('Left-Bottom' ) ) ,true ,0 ,0 );

 m_graphics.textAlignment(AlignCenter ,AlignBottom );
 m_graphics.text(250.0 ,200.0 ,char_ptr(char_ptr('Center-Bottom' ) ) ,true ,0 ,0 );

 m_graphics.textAlignment(AlignRight ,AlignBottom );
 m_graphics.text(250.0 ,250.0 ,char_ptr(char_ptr('Right-Bottom' ) ) ,true ,0 ,0 );

 m_graphics.textAlignment(AlignLeft ,AlignCenter );
 m_graphics.text(250.0 ,300.0 ,char_ptr(char_ptr('Left-Center' ) ) ,true ,0 ,0 );

 m_graphics.textAlignment(AlignCenter ,AlignCenter );
 m_graphics.text(250.0 ,350.0 ,char_ptr(char_ptr('Center-Center' ) ) ,true ,0 ,0 );

 m_graphics.textAlignment(AlignRight ,AlignCenter );
 m_graphics.text(250.0 ,400.0 ,char_ptr(char_ptr('Right-Center' ) ) ,true ,0 ,0 );

 m_graphics.textAlignment(AlignLeft ,AlignTop );
 m_graphics.text(250.0 ,450.0 ,char_ptr(char_ptr('Left-Top' ) ) ,true ,0 ,0 );

 m_graphics.textAlignment(AlignCenter ,AlignTop );
 m_graphics.text(250.0 ,500.0 ,char_ptr(char_ptr('Center-Top' ) ) ,true ,0 ,0 );

 m_graphics.textAlignment(AlignRight ,AlignTop );
 m_graphics.text(250.0 ,550.0 ,char_ptr(char_ptr('Right-Top' ) ) ,true ,0 ,0 );
