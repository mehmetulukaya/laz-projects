    ...
    begin
     ...
     if buf[0 ] = 'P' then
      ...
      // BeginPath
       ...
       Val(char_ptr(ts ) ,style_.left_fill ,code );

       ts:=strtok(NIL ); // right_style

       Val(char_ptr(ts ) ,style_.right_fill ,code );

       ts:=strtok(NIL ); // line_style

       Val(char_ptr(ts ) ,style_.line ,code );

       ts:=strtok(NIL ); // ax

       Val(char_ptr(ts ) ,ax ,code );

       ts:=strtok(NIL ); // ay

       Val(char_ptr(ts ) ,ay ,code );
     ...
     if buf[0 ] = 'C' then
      begin
       ...
       Val(char_ptr(ts ) ,cx ,code );

       ts:=strtok(NIL ); // cy

       Val(char_ptr(ts ) ,cy ,code );
