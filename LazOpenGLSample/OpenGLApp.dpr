...
begin
  ...
  begin
    ...
    glBegin(GL_QUADS);
      ...
      glTexCoord2f(0, 0);  glVertex3fv(@Vertex[V1-1]);
      glTexCoord2f(U, 0);  glVertex3fv(@Vertex[V2-1]);
      glTexCoord2f(U, V);  glVertex3fv(@Vertex[V3-1]);
      glTexCoord2f(0, V);  glVertex3fv(@Vertex[V4-1]);
    glEnd();
  end;
end;
